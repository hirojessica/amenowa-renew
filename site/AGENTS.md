...
- On 2026-09-07, user requested social link preview cards. All prerendered pages include OGP and X large-card tags, with page-specific titles/descriptions and one shared 1200x630 image at public/assets/ogp-amenowa-v1.png. The artwork uses the official logo assets and #0081a6; editable source is design/ogp.html. NEWS uses each article's title, excerpt and publication time. SITE_URL controls absolute share URLs; retain demo noindex until a production launch is authorized.
