...
storySections:
  ...
  - label: 02｜水・自然資本の調査・実装
    ...
    body: >-
      ...
      現在は、観測するだけではなく、リーキーダムやカープランクなど、自然の力を活かして水の流れを遅らせ、土地への浸透を促す<strong>「水を守り、育てる」実装</strong>へ進んでいます。


      amenowaは、現地調査 → モニタリング → データ化 → 改善施策までを一貫して支援します。
  - label: 03｜地域共創・環境教育
    headline: 研究を、地域の学びと行動へ。
    body: |-
...
chronology:
  title: ルスツリゾート 水循環プロジェクト年表
  intro: この4つのサービスが、2024年から2026年にかけてどのようにつながり、プロジェクトが進化してきたのかを、年表で紹介します。
  outcomeTitle: ルスツモデル
  outcome: 企業単独の取組から、自治体・大学・研究機関・地域を含む6者連携へ。水を知り、測り、守り育てるプロセスそのものが、地域の価値になる。
  years:
    - year: 2024
      phase: 知る
      description: 水を地域の自然資本として位置づけ、プロジェクトを構想する。
      periods:
        - label: 前半〜夏
          events:
            - category: strategy
              title: 水を軸とした水循環プロジェクトの構想
              next: シンポジウム・現地調査へ
              related: ''
              image: ''
              imageAlt: ''
    ...
    - year: 2025
      phase: 測る
      description: 現地調査とIoTモニタリングによって、水の来し方・行き先を把握する。
      periods:
        - label: 5月〜夏
          events:
            - category: research
              title: 水文地質・地下水・湧水・森林調査
              next: 観測地点・センサー設計へ
              related: ''
              image: ''
              imageAlt: ''
    ...
    - year: 2026
      phase: 守る・育てる、つなぐ
      description: 観測したデータをもとに、森林やグリーンインフラの実装、共同研究、教育、地域連携へ広げる。
      periods:
        - label: 5月
          events:
            - category: research
              title: Phase 1.5：冬季課題の検証・再設計（5/7〜10）
              next: 本格実装へ
              related: ''
              image: ''
              imageAlt: ''
              caption: ''
            - category: research
              title: EAST上部「ウド谷」で湧水確認・簡易観測井戸新設
              next: 観測エリア拡大へ
              related: ''
              image: ''
              imageAlt: ''
        ...
        - label: 7月
          events:
            - category: strategy
              title: 熊本県立大学COI-NEXT、名古屋工業大学等との共同研究
              next: 研究実証フィールド化
              related: 02 調査・実装
              image: ''
              imageAlt: ''
            ...
            - category: research
              ...
              caption: ''
            - category: research
              title: 雨量・地下水データのWeb連携
              next: AquaInsights型の可視化へ
              related: ''
              image: ''
              imageAlt: ''
              caption: ''
