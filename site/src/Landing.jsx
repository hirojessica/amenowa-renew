import {Arrow,Button,Media,ContactCTA} from './App.jsx';
...
import {ProductLinks,CaseVisual} from './ContentPages.jsx';
...
export function Home(){const featured=cases.find(item=>item.slug==='rusutsu-resort')||cases[0];return <>
  ...
  <section className="home-works"><h2 className="eyebrow">PRODUCTS</h2><div className="home-works-content"><ProductLinks/><Media name="AquaInsights / MEGURU 公開用サンプル画面"/></div></section>
  ...
  <TeamIntro/>
  <section className="home-news content-width"><div className="section-heading"><div><span className="eyebrow">INSIGHTS</span><h2>お知らせ・ブログ</h2></div><a className="text-link" href={href('insights/')}>すべて見る<Arrow/></a></div><NewsRows items={posts.slice(0,3)}/></section><ContactCTA/>
</>;}
